...
public class WordFlashAnswerDelayed extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_flash_answer_delayed);
        initializeLayout();
    ...
    private void initializeLayout() {
        ...
        none = (Button) findViewById(R.id.waiid_none);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_word_flash_answer_delayed, menu);
        return true;
    }
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.word_audio_immediate_answer_done || view.getId() == R.id.waiid_none){
            Log.d("done","done");
    ...
    private void saveToSharedPreference(int points) {
        ...
        if(scoreSharedPreference.contains("score")){
            ...
            reportScoreSave.scoreSave.add(getResources().getString(R.string.auditory_delayed_recall_new)+":" +String.valueOf(points));
        }
    }
