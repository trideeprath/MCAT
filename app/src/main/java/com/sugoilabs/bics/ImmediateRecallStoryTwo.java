...
public class ImmediateRecallStoryTwo extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_immediate_recall_story_two);
        initializeLayout();
    ...
    public void showInstructionDialogBox(){
        MaterialDialog.Builder dialogBuilder = new MaterialDialog.Builder(this).title(R.string.instruction).contentColor(Color.RED).content(R.string.delayedRecallStoryTwoInstruction).positiveText(R.string.next).cancelable(false);
        dialogBuilder.show();
    ...
    private void saveToSharedPreference(int points) {
        ...
        if(scoreSharedPreference.contains("score")){
            ...
            reportScoreSave.scoreSave.add(getResources().getString(R.string.auditory_immediate_recall_story_new) + ":" + String.valueOf(points));
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_immediate_recall_story_two, menu);
        return true;
    }
