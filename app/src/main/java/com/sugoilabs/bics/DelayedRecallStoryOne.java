...
public class DelayedRecallStoryOne extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delayed_recall_story_one);
        initializeLayout();
    ...
    public void showInstructionDialogBox(){
        MaterialDialog.Builder dialogBuilder = new MaterialDialog.Builder(this).title(R.string.instruction).contentColor(Color.RED).content(R.string.delayedRecallStoryOneInstructionNew).positiveText(R.string.next).cancelable(false);
        dialogBuilder.show();
    ...
    private void initializeLayout() {
        ...
        none = (Button)findViewById(R.id.drso_none);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_delayed_recall_story_one, menu);
        return true;
    }
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.picture_flash_immediate_answer_done || view.getId() == R.id.drso_none){
            Log.d("done","done");
            String sentence1 = answerText.getText().toString();
            //score = calculateScore(sentence1, audioNumber);
            int score = calculateScoreByWords(sentence1, 1);
            ...
            Intent intent = new Intent(this, DelayedRecallStoryTwo.class);
            intent.putExtra("StoryOneScore", score);
