...
public class PictureFlashAnswerDelayedTab extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picture_flash_answer_delayed_tab);
        initializeLayout();
    ...
    private void initializeLayout() {
        ...
        buttonsLayout  = (LinearLayout) findViewById(R.id.pfaid_layout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_picture_flash_answer_delayed_tab, menu);
        return true;
    }
    ...
    private void saveToSharedPreference(int points) {
        ...
        if(scoreSharedPreference.contains("score")){
            ...
            reportScoreSave.scoreSave.add(getResources().getString(R.string.visual_name_delayed_recall_new)+":" +String.valueOf(points));
        }
