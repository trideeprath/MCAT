...
public class WordAudioFlashAnswerImmediateTab extends ActionBarActivity implements View.OnClickListener {
    ...
    public void showInstructionDialogBox(){
        MaterialDialog.Builder dialogBuilder = new MaterialDialog.Builder(this).title(R.string.instruction).contentColor(Color.RED).content(R.string.audioWordAnswerImmediateInstruction).positiveText(R.string.next).cancelable(false);
        dialogBuilder.show();
