...
public class ImmediateRecallStoryOne extends ActionBarActivity implements View.OnClickListener {
    ...
    public void showInstructionDialogBox(){
        MaterialDialog.Builder dialogBuilder = new MaterialDialog.Builder(this).title(R.string.instruction).contentColor(Color.RED).content(R.string.delayedRecallStoryOneInstruction).positiveText(R.string.next).cancelable(false);
        dialogBuilder.show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_immediate_recall_story_one, menu);
        return true;
    }
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.picture_flash_immediate_answer_done || view.getId() == R.id.drso_none){
            ...
            Intent intent = new Intent(this, StoryPlayTwo.class);
